...
character(len=TXTLEN_FILE), target, save, public :: MonthlyFacFile = 'DataDir/MonthlyFac.POLL'
!POLL replaced by name of pollutant in EmisSplit
character(len=TXTLEN_FILE), target, save, public :: DailyFacFile = 'DataDir/DailyFac.POLL'
character(len=TXTLEN_FILE), target, save, public :: HourlyFacFile = 'DataDir/HourlyFacs.INERIS'
character(len=TXTLEN_FILE), target, save, public :: HourlyFacSpecialsFile = 'NOTSET'
!POLL replaced by name of pollutant in EmisSplit
character(len=TXTLEN_FILE), target, save, public :: SplitDefaultFile = 'DataDir/inp_rv4_32_beta/emissplit.defaults.POLL'
!POLL replaced by name of pollutant in EmisSplit
character(len=TXTLEN_FILE), target, save, public :: SplitSpecialsFile = 'DataDir/inp_rv4_32_beta/emissplit.specials.POLL'
